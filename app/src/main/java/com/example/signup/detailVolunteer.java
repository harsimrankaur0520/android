...
public class detailVolunteer extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    txtdata = Integer.parseInt(spinnertext.getText().toString());
                    if(txtdata>=10){
                        //time info = new time(txtdata);
                        sendUserTime();
                        Toast.makeText(detailVolunteer.this, "you have booked a slot", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(detailVolunteer.this, "Please enter value more than 10", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
